...
Public Class crEntregaCarteira
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Relatorios.crEntregaCarteira.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEntregaCarteira
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEntregaCarteira = New crEntregaCarteira()
        rpt.Site = Me.Site
        Return rpt
    End Function
